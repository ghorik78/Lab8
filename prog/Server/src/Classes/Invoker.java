...
public class Invoker {
    ...
    public void add_if_max(Route route, String[] args, String usr) throws SQLException, IOException, NoSuchFieldException, IllegalAccessException {
    ...
    @CommandData(name="identifyColor", description="")
    public void identifyColor(String[] args) throws SQLException, IOException {
        IdentifyColorCommand identifyColorCommand = new IdentifyColorCommand("identifyColor", args, usr, commander);
        manager.invoke(identifyColorCommand, args, usr);
    }
}
